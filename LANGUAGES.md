...
BOSC Community Library prioritizes multilingual access because public educational resources should serve learners in the languages they actually use. This catalog identifies resources with multilingual or language-specific educational materials that contributors may reference when improving the library.

| Language | Resource Title | URL | License Type |
| --- | --- | --- | --- |
| English | MIT OpenCourseWare | https://ocw.mit.edu/ | CC BY-NC-SA 4.0 |
