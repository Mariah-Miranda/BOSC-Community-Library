...
It complements [`docs/CONTRIBUTING.md`](CONTRIBUTING.md),
[`docs/CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md),
[`docs/SUSTAINABILITY.md`](SUSTAINABILITY.md), and
[`docs/LEGAL_ANALYSIS.md`](LEGAL_ANALYSIS.md).
...
3. **Reciprocity.** Improvements distributed to others must remain available
   under GPL-3.0, as described in `docs/LEGAL_ANALYSIS.md`.
...
1. A proposal is opened as an issue, an RFC document under `docs/`, or a draft
   pull request.
...
[`docs/LEGAL_ANALYSIS.md`](LEGAL_ANALYSIS.md). Forks are welcome under GPL-3.0,
...
committee (see [`docs/SUSTAINABILITY.md`](SUSTAINABILITY.md)), trademarks and
